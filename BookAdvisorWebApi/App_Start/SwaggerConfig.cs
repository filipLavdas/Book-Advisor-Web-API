...
using BookAdvisorWebApi;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace BookAdvisorWebApi
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "BookAdvisorWebApi");
        ...
        {
            return System.String.Format(@"{0}\data\BookAdvisorWebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
